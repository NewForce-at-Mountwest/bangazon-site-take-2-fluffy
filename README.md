...
After logging in, you can click on the link in the nav bar for "sell a product" and a form will be presented with allows you to add the details of the product you wish to add.  You can even upload an image of the product!  Once you hit 'create' you will be redirected to the details view for that product.  NOTE:  If local delivery is selected, the user must input a city or they will be redirected back to the page with an error.  The 'Image' upload is not required.
